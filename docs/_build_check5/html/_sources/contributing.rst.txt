...
.. code-block:: python
   ...
   def validate_inputs(
       ...
       ------
       ValueError
           If any tensor has incompatible shape or type
       TypeError
...
- 📖 Read the [Documentation](https://base-attentive.readthedocs.io/)
- 💬 Ask in GitHub Discussions
- 🐛 Open an Issue for bugs
- 🎯 Create a Discussion for feature ideas
