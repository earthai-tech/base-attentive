...
\item \textbf{Data availability.}
  ...
  pre-computed result tables, and all publication figures are publicly
  available in the reproducibility archive deposited on Zenodo
  (\url{https://doi.org/10.5281/zenodo.20642121}, CC-BY~4.0).
  ERA5 reanalysis data are freely accessible via the Copernicus
  Climate Data Store (\url{https://cds.climate.copernicus.eu}).
  The Global Flood Database used for satellite validation is
  available at \url{https://global-flood-database.cloudtostreet.ai}.
  EM-DAT flood event records are available on request from
  \url{https://www.emdat.be}.

\item \textbf{Code availability.}
  All scripts used to produce the results, tables, and figures in
  this manuscript are available at
  \url{https://github.com/earthai-tech/padrnet} (tagged release
  \texttt{v1.0.0-matg-resubmission}) and archived on Zenodo
  (\url{https://doi.org/10.5281/zenodo.20642121}).
  The full Base-Attentive/PADR-Net framework and API documentation
  are available at
